            ...
            <div class="container">
               <div class="text-bg">
                  ...
                  <div class="container">
                     ...
                     <form class="main-form" id="from-Search" method="POST" action="viewReservation">
                        <h3>Find Your Way</h3>
                        <div class="row">
                           <div class="col-md-9">
                              <div class="row">
                                 ...
                                 <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                                    <label >Adults</label>
                                    <input type="number" class="form-control" id="Adults" name="Adulto" min="0" max="9" value="0">
                                 </div>
                                 ...
                                 <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                                    ...
                                    <input type="number" class="form-control" id="Children" name="Ninos" min="0" max="9" value="0" disabled>
                                 </div>
                              </div>
                           </div>
